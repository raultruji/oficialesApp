...
import oficiales_app.security.CustomAuthenticationProvider;
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		...
		return httpSecurity.authorizeHttpRequests(auth -> {
			...
			auth.requestMatchers(POST, "/oficialesapp/users/**").hasAuthority(Permission.ADMIN_CREATE.name());
			auth.requestMatchers(DELETE, "/oficialesapp/users/**").hasAuthority(Permission.ADMIN_DELETE.name());
			auth.requestMatchers(PUT, "/oficialesapp/users/**").hasAuthority(Permission.ADMIN_UPDATE.name());
			auth.requestMatchers(GET, "/oficialesapp/users/**").hasAnyAuthority(Permission.ADMIN_READ.name(),
					Permission.USER_READ.name());
			auth.requestMatchers("/oficialesapp/mainmenu/**").authenticated();
			...
			fl.successHandler(successHandler()).permitAll();
		})
